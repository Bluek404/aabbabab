...
func Index() []byte {
	...
	head(_buffer, "")
	_buffer.WriteString("<body><div id=\"sidebar\"><div id=\"logo\"></div><div id=\"sidebar-content\"><button id=\"new-topic\" class=\"button\">发表新主题</button></div></div><div id=\"content\"><div id=\"messages\"></div><div id=\"input-box\"><div id=\"toolbar\"><button id=\"edit\" class=\"tab\" disabled>编辑</button><button id=\"preview\" class=\"tab\">预览</button><button id=\"submit\" class=\"button\" disabled>发送</button></div><textarea id=\"input\"></textarea><div id=\"preview-box\"></div></div></div><div id=\"init\"><div id=\"i\"><p>请输入用户名：</p><input id=\"inputName\"/><button id=\"submitName\">确定</button></div></div><div class=\"background\"><div id=\"new-topic-box\"></div></div></body></html>")
